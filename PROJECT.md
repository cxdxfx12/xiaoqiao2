...
> **🚨 最新改动 2026-07-24 已同步至 PROJECT_v1.1_new.md（本项目最完整最新版）**
> 以下两项大改动建议直接跳转到 PROJECT_v1.1_new.md 对应章节阅读：
> 1. **功能7（T7）· 快递模板自动识别 + 可视化管理** — 8家内置模板/总开关+逐条启用禁用/双击行可点开编辑/增删改查，自定义模板自动覆盖同ID内置模板。详细章节见 PROJECT_v1.1_new.md §4.9 + §7.2 新增2个对话框 + §12 附录速查表。
> 2. **品牌项目图标全套升级为「祥云快递盒」方案B** — App Bundle .icns / Dock / Finder / 所有窗口标题栏 / Alt-Tab / 关于页 Logo / 9 档尺寸 QRC PNG 资源 全部统一。详见 PROJECT_v1.1_new.md §4.8 + 一键再生成工具 tools/gen_icon。
